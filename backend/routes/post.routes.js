...
import { addPost, commentPost, deletePost, editPost, getAllPosts, likePost, replyComment } from '../controllers/post.controller.js';
...
router.post('/reply', protectRoute, replyComment);
